...
<html>
	...
	<body onload="autoScrollTo('div2');" onload="return false;" >
		...
		<div id='cssmenu'>
		<ul>
				<li class='active'><a href='/Agomel/beginnings.php'><span>The Beginning</span></a></li>
				<li><a href='/Agomel/gameplays.php'><span>Gameplay</span></a></li>
				<li><a href='/Agomel/cp.php'><span>User Control Panel</span></a></li>
				<li><a href='/Agomel/dlclients.php'><span>Download Client</span></a></li>
				<li><a href='/Agomel/contacts.php'><span>Contact</span></a></li>
		</ul>
		</div>	
<ul class="slides">
    ...
    <li class="slide-container">
		...
		<div id="div2" class="contentbox">credit to: Nishioka Brosis</div>
